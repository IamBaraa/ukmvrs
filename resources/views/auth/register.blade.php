            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="matric" class="col-md-4 col-form-label text-md-right">Matric Number</label>
                            <div class="col-md-6">
                                {{Form::text('matric', '', ['class' => 'form-control', 'placeholder' => ''])}}
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('phone_no', '', ['class' => 'form-control', 'placeholder' => ''])}}
                        ...
                        <br><p>Already have an account? <a class="btn btn-dark btn-sm" href="/login" role="button">Login</a><br>
                    </form>
                </div>
            </div>
        </div>
